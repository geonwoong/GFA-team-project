...
@media screen and (max-width:768px) {
    ...
    .image{
    background:#ddd url(http://teamgfa.shop/wp-content/uploads/2021/04/time-3096535_1920-1.png) no-repeat center center;
    background-size:cover;
    height:auto;
    width:auto;
    min-width:320px;
